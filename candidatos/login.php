...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        $sql = "SELECT id, nombre, password FROM candidatos WHERE email = ?";
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header bg-primary text-white">
                    <h3 class="mb-0">Iniciar Sesión como Candidato</h3>
                </div>
                <div class="card-body">
                    <?php if (!empty($errors)): ?>
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST">
                        ...
                        <div class="mt-3">
                            ...
                            <p>¿Eres una empresa? <a href="../empresas/login.php">Iniciar sesión como empresa</a></p>
                        </div>
                    </form>
                </div>
            </div>
